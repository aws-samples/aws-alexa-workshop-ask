...
def get_loan_offer(intent_request):
	...
	return close(
        ...
        {
            'contentType': 'PlainText',
            'content': 'The current rate for {} loan is {:.2%}. You are qualified for new load rate, call xxxxx to contact with your financial adviser'.format(loan_type.lower(), rate)
        }
	)
